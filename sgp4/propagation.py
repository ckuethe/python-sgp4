...
def sgp4init(
     ...
     satrec.isimp   = 0;   satrec.deepspace = False; satrec.aycof    = 0.0;
     ...
     (
       ...
       rp,    rteosq,sinio , satrec.gsto,
           ...
           satn, whichconst, satrec.ecco, epoch, satrec.inclo, satrec.no, satrec.deepspace,
           satrec.afspc_mode
         );
     satrec.error = 0;
     ...
     if omeosq >= 0.0 or satrec.no >= 0.0:
         ...
         if 2*pi / satrec.no >= 225.0:
             ...
             (satrec.ecco, satrec.inclo, satrec.nodeo, satrec.argpo, satrec.mo
                   ...
                   satrec, inclm, satrec.initialized,
                   satrec.ecco, satrec.inclo, satrec.nodeo, satrec.argpo, satrec.mo,
                   satrec.afspc_mode
                 );
...
def sgp4(satrec, tsince, whichconst=None):
     ...
     if satrec.deepspace:
         ...
         ep, xincp, nodep, argpp, mp = _dpper(
               satrec, satrec.inclo,
               False, ep, xincp, nodep, argpp, mp, satrec.afspc_mode
             );
         if xincp < 0.0:
